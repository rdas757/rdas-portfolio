  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        <a href="#" className="text-xl font-bold text-navy-800">Rahul Das</a>
            ...
            <ul className="flex flex-col space-y-2">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a 
                    href={link.href} 
                    className={`block px-6 py-2 ${activeSection === link.href.substring(1) ? "text-accent font-medium" : "text-navy-700"}`}
